...
const HeaderN = () => {
    ...
    const cerrarSesion = () => {
        ...
        window.location.href = '/InicioSesion'; // Redirige al inicio de sesión
    };
    ...
    const paths = [
        ...
        {
            id: 9, name: 'Cerrar Sesion', action: cerrarSesion
        }
                    ...
                    <IonList>
                        {paths.map((enlace) => (
                            <IonItem
                                ...
                                className="opcion"
                                button={true}
                                onClick={() => enlace.action ? enlace.action() : (window.location.href = enlace.url)}
                            >
                                {enlace.name}
                            </IonItem>
                        ))}
