        ...
        <IonContent id='main' fullscreen className="ion-padding">
          ...
          <div className="card">
            <div className="card-image-container">
              <img className="card-image" src="public/assets/images/Parque_Natural_Gómez_Carreño.jpg" alt="Parque Natural Gómez Carreño" />
            </div>
          ...
          <div className="fauna-grid">
            <img src="public/assets/images/aguilucho.jpg" alt="Una imagen de un Aguilucho" />
            <img src="public/assets/images/picalor.jpg" alt="Una imagen mostrando un Picaflor" />
            <img src="public/assets/images/piden.jpg" alt="Imagen mostrando un Piden" />
          </div>
          ...
          <div className="flora-grid">
            <img src="public/assets/images/Chagual Azul.jpg" alt="Una imagen de un Chagual Azul" />
            <img src="public/assets/images/Flor de la Culebra.jpeg" alt="Una imagen mostrando una Flor de la Culebra" />
            <img src="public/assets/images/Oreja de Zorro.jpg" alt="Imagen mostrando una flor llamada Oreja de Zorro" />
          </div>
